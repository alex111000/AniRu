...
class MainFragment : RowsSupportFragment() {
    ...
    private val animeVostViewModel by quillParentViewModel<MainAnimeVostViewModel>()
    private val providersViewModel by quillParentViewModel<MainProvidersViewModel>()
    ...
    private fun getViewModel(rowId: Long): BaseCardsViewModel? = when (rowId) {
        ...
        MainViewModel.ANIMEVOST_ROW_ID -> animeVostViewModel
        MainViewModel.PROVIDERS_ROW_ID -> providersViewModel
        else -> null
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycle.addObserver(animeVostViewModel)
        viewLifecycleOwner.lifecycle.addObserver(providersViewModel)
